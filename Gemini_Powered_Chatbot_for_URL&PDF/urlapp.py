...
with st.sidebar:
    ...
    st.markdown("---")
    st.header("🔗 URL Input")
    url = st.text_input("Paste a public webpage URL")
...
# Main code
if st.button("🚀 Get Answer") and api_key and url:
    try:
    ...
    st.warning("⚠️ Please enter both the API key and a valid URL to proceed.")
